...
public class GooTaskListCollectionAdapter extends ArrayAdapter<GooTaskList> {
    ...
    public GooTaskListCollectionAdapter(Context context, int textViewResourceId, List<GooTaskList> lists) {
