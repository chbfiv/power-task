...
public class Setup {
     ...
     * below.
     */
    private static final String APP_NAME = "7askh4ck";

    /**
     * The URL of the production service.
     */
    public static final String PROD_URL = "https://https://www.google.com/accounts/ClientLogin";

    /**
     * The C2DM sender ID for the server. A C2DM registration with this name
     * must exist for the app to function correctly.
     */
    public static final String SENDER_ID = "h4ck7ask@gmail.com";
